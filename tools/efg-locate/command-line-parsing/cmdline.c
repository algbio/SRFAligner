...
const char *gengetopt_args_info_usage = "Usage: efg-locate graph.gfa patterns.fasta {paths.gfa,seeds.gaf}";
...
const char *gengetopt_args_info_full_help[] = {
  ...
  "      --approximate-edge-match-min-count-heuristic\n                                Together with the\n                                  --approximate-edge-match-min-count option,\n                                  compute the edge occurrences occurring at\n                                  most COUNT times only after not finding any\n                                  long match of some read substring in the\n                                  graph spanning 3+ nodes  (default=off)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->approximate_edge_match_min_count_heuristic_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->approximate_edge_match_min_count_heuristic_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->approximate_edge_match_min_count_heuristic_help = gengetopt_args_info_full_help[6] ;
  args_info->approximate_min_coverage_help = gengetopt_args_info_full_help[7] ;
  args_info->approximate_stats_help = gengetopt_args_info_full_help[8] ;
  args_info->reverse_complement_help = gengetopt_args_info_full_help[9] ;
  args_info->rename_reverse_complement_help = gengetopt_args_info_full_help[10] ;
  args_info->split_output_matches_help = gengetopt_args_info_full_help[11] ;
  args_info->split_output_matches_graphaligner_help = gengetopt_args_info_full_help[12] ;
  args_info->threads_help = gengetopt_args_info_full_help[13] ;
  args_info->overwrite_help = gengetopt_args_info_full_help[14] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->approximate_edge_match_min_count_heuristic_given)
    write_into_file(outfile, "approximate-edge-match-min-count-heuristic", 0, 0 );
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "approximate-edge-match-min-count-heuristic",	0, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Together with the --approximate-edge-match-min-count option, compute the edge occurrences occurring at most COUNT times only after not finding any long match of some read substring in the graph spanning 3+ nodes.  */
          else if (strcmp (long_options[option_index].name, "approximate-edge-match-min-count-heuristic") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->approximate_edge_match_min_count_heuristic_flag), 0, &(args_info->approximate_edge_match_min_count_heuristic_given),
                &(local_args_info.approximate_edge_match_min_count_heuristic_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "approximate-edge-match-min-count-heuristic", '-',
                additional_error))
              goto failure;
